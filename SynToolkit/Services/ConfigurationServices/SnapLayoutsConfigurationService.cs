...
namespace SynToolkit.Services.ConfigurationServices
{
    ...
    {
        private const string SYNTOOLKIT_STORE_KEY_NAME = @"HKLM\SOFTWARE\SynToolkit\Services\SnapLayouts";
        ...
        {
            return !RegistryHelper.IsMatch(ADVANCED_KEY_NAME, ENABLE_SNAP_ASSIST_FLYOUT_VALUE_NAME, 0)
                && !RegistryHelper.IsMatch(ADVANCED_KEY_NAME, ENABLE_SNAP_BAR_VALUE_NAME, 0);
        }
    }
}
