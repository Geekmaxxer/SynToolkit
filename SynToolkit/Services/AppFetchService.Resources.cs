...
{
    /// <summary>
    /// DTOs and Windows Update SOAP request templates, ported verbatim from AME.AppFetch's
    /// StoreService.resources.cs (https://github.com/Ameliorated-LLC/appfetch, MIT License,
    /// Copyright (c) Ameliorated LLC). The SOAP bodies are static protocol payloads required
    /// by Microsoft's WU/Store services and are not meaningfully editable.
    /// </summary>
    public partial class AppFetchService
    {
        public record StoreInstallerPackageResponseDto(
            [property: JsonPropertyName("Data")] Data? Data
        );

        public record Data(
            [property: JsonPropertyName("PackageIdentifier")] string? PackageIdentifier,
            [property: JsonPropertyName("Versions")] List<Versions>? Versions
        );

        public record Versions(
            [property: JsonPropertyName("PackageVersion")] string? PackageVersion,
            [property: JsonPropertyName("DefaultLocale")] DefaultLocale? DefaultLocale,
            [property: JsonPropertyName("Installers")] List<Installers>? Installers
        );
        ...
        public record Installers(
            ...
            [property: JsonPropertyName("InstallerLocale")] string? InstallerLocale,
            [property: JsonPropertyName("MinimumOSVersion")] string? MinimumOSVersion,
            [property: JsonPropertyName("InstallerSwitches")] InstallerSwitches? InstallerSwitches,
            [property: JsonPropertyName("Architecture")] string? Architecture,
            [property: JsonPropertyName("InstallerType")] string? InstallerType
        );
        ...
        {
            [JsonPropertyName("highlightedList")]
            public List<StoreProductListDto>? HighlightedList { get; init; }

            [JsonPropertyName("productsList")]
            public List<StoreProductListDto>? ProductsList { get; init; }
        }
        ...
        public record StoreProductListDto
        {
            ...
            public string? StrikethroughPrice { get; init; }
        ...
        public record StorePackageDto : IComparable<StorePackageDto>
        {
            [JsonPropertyName("name")] public string? Name { get; init; }

            [JsonPropertyName("extension")] public string? FileExtension { get; init; }

            [JsonPropertyName("uri")] public string? ResourceUri { get; init; }

            [JsonPropertyName("revisionNumber")] public string? Revision { get; init; }

            [JsonPropertyName("updateID")] public string? UpdateIdentifier { get; init; }

            [JsonPropertyName("id")] public string? PackageId { get; init; }

            [JsonPropertyName("size")] public double? Size { get; init; }

            [JsonPropertyName("digest")] public string? Checksum { get; init; }

            [JsonPropertyName("lastModified")] public DateTime? LastModified { get; init; }

            [JsonPropertyName("originalIndex")] public int? OriginalIndex { get; init; }

            [JsonPropertyName("commandLines")] public string? CommandLines { get; init; }

            public int CompareTo(StorePackageDto? other) => other is null ? 1 : string.Compare(Name, other.Name, StringComparison.Ordinal);
        }
...
";
        ...
        private const string UrlContent = @"
<s:Envelope
...
";
        ...
        private const string WUAContent = @"
<s:Envelope
	xmlns:a=""http://www.w3.org/2005/08/addressing""
	xmlns:s=""http://www.w3.org/2003/05/soap-envelope"">
	<s:Header>
