    ...
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static IHostBuilder AddConfigurationButtonItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, ConfigurationButton> configurationDictionary = new()
            {
                ...
                ["HWiNFO"] = new(buttonCommand = new LaunchPortableToolCommand("HWiNFO64.exe"), App.GetValueFromItemList("HWiNFO"), App.GetValueFromItemList("HWiNFODescription"), ConfigurationType.Advanced, "ms-appx:///assets/Icons/Devices.png"),
