...
SynToolkit includes third-party open source software components. License texts for bundled components are included with the application where required by their respective licenses.

## Simple Icons

The installer catalog includes selected brand marks from the Simple Icons project, distributed under the CC0 1.0 Universal license. Brand names and logos remain trademarks of their respective owners.
...
The WinGet-manifest fallback uses YamlDotNet, distributed under the MIT License.

Source and license: https://github.com/aaubry/YamlDotNet
